...
apt-get update
apt-get install -y git apt-transport-https ca-certificates curl software-properties-common python3-pip

# Instalar dependencias de Python (solo si se necesitan en host, no en contenedor)
...
# Crear archivo .env dinámicamente
...
# Crear servicio systemd para ejecutar el contenedor como servicio
